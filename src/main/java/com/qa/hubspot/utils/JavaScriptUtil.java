...
public class JavaScriptUtil {
	...
	public void clickElementByJS(WebElement element) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", element); // bad method because it clicks from DOM, no matter even if you don't have the element to click on. 99% it will click even if its not there, which is not correct etsting, its a bug. 
	}
